...
for model in resnet50 mpvit_tiny mpvit_xsmall dvit_tiny dvit_base
do
	python predIE.py --model ${model} --data_dir '../dataset/V4_ec' --out_dir './output/V4_ec' -e 40_mount --epochs 40
done
